...
function calc() {
  //callories
  var resultCalc = document.querySelector('.calculating__result span');
  var sex, height, weight, age, activity;
...
function cards() {
  //Cards
  var MenuCards = /*#__PURE__*/function () {
    function MenuCards(src, alt, title, descr, price, parent) {
      _classCallCheck(this, MenuCards);
    ...
    _createClass(MenuCards, [{
      ...
      value: function render() {
        ...
        if (this.classes.length === 0) {
          ...
          this.classes.forEach(function (everyClass) {
            return element.classList.add(everyClass);
          });
        }
  ...
  new MenuCards("img/tabs/vegy.jpg", "vegy", "Меню 'Фитнес'", "Меню 'Фитнес' - это новый подход к приготовлению блюд: больше свежих овощей и фруктов. Продукт активных и здоровых людей. Это абсолютно новый продукт с оптимальной ценой и высоким качеством!", 9, '.menu__field .container').render();
  new MenuCards("img/tabs/elite.jpg", "elite", "Меню 'Премиум'", "В меню “Премиум” мы используем не только красивый дизайн упаковки, но и качественное исполнение блюд. Красная рыба, морепродукты, фрукты - ресторанное меню без похода в ресторан!", 15, '.menu__field .container').render();
  new MenuCards("img/tabs/post.jpg", "post", "Меню 'Постное'", "Меню “Постное” - это тщательный подбор ингредиентов: полное отсутствие продуктов животного происхождения, молоко из миндаля, овса, кокоса или гречки, правильное количество белков за счет тофу и импортных вегетарианских стейков.", 20, '.menu__field .container').render();
}
...
function modal() {
  ...
  var timerInterval = setTimeout(openModal, 5000);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('2022-08-18');
